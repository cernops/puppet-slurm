...
describe 'real_memory Fact' do
  ...
  it "should return 15900 for 16GB server" do
    File.stubs(:readlines).with('/proc/meminfo').returns(meminfo_fixture_readlines('16gb'))
  ...
  it "should return 32100 for 32GB server" do
    File.stubs(:readlines).with('/proc/meminfo').returns(meminfo_fixture_readlines('32gb'))
  ...
  it "should return 64400 for 64GB server" do
    File.stubs(:readlines).with('/proc/meminfo').returns(meminfo_fixture_readlines('64gb'))
  ...
  it "should return 129000 for 128GB server" do
    File.stubs(:readlines).with('/proc/meminfo').returns(meminfo_fixture_readlines('128gb'))
