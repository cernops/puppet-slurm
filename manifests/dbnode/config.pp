...
#
# @param file_name The name of the temporary dbd file before being processed by the password manager or manually copied and modified; if you intend to use a clear password in the storage_pass variable, which is NOT recommanded, using the default slurmdbd.conf as file name is enough
...
# @param storage_pass The the database password identifier; it should NOT contain the actual password but an identifier later changed
